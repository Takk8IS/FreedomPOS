                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-6">
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        <Label htmlFor="showLogo">
                                            {t("settings.show_logo")}
                                        </Label>
                                        <Switch
                                            id="showLogo"
                                            checked={invoiceSettings.showLogo}
                                            onCheckedChange={() =>
                                                handleInvoiceToggle("showLogo")
                                            }
                                        />
                                    </div>
                                    <div className="flex items-center justify-between">
                                        <Label htmlFor="showHeader">
                                            {t("settings.show_header")}
                                        </Label>
                                        <Switch
                                            id="showHeader"
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="warrantyText">
                                            {t("settings.warranty_text")}
                                        </Label>
                                        <Textarea
                                            id="warrantyText"
                                            name="warrantyText"
                            ...
                            <CardContent>
                                <InvoiceTemplate
                                    ...
                                    customer={{
                                        name: "John Doe",
                                        address:
                                            "456 Customer St, City, State 12345",
                ...
                <TabsContent value="payment">
                    <Card>
                        ...
                        <CardContent className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-2">
                                            <CreditCard className="h-4 w-4" />
                                            <Label htmlFor="card-payments">
                                                {t("settings.card_payments")}
                                            </Label>
                                        </div>
                                        <Switch
                                            id="card-payments"
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-2">
                                            ...
                                            >
                                                ...
                                                />
                                                <path
                                                    d="M12 13.5C11.9816 13.1754 12.0692 12.8536 12.2495 12.5832C12.4299 12.3127 12.6933 12.1093 13 12C13.3759 11.8563 13.7132 11.6274 13.9856 11.3311C14.2579 11.0348 14.4577 10.6794 14.5693 10.2939C14.6809 9.90836 14.7013 9.50279 14.6287 9.1076C14.5562 8.71241 14.3928 8.33942 14.1513 8.01493C13.9099 7.69044 13.5968 7.42342 13.2336 7.23416C12.8704 7.04491 12.4672 6.93772 12.0545 6.92222C11.6418 6.90672 11.2311 6.98322 10.8538 7.14498C10.4766 7.30675 10.1428 7.54986 9.875 7.85498"
                                                    stroke="currentColor"
                                                    strokeWidth="2"
                                                    strokeLinecap="round"
                                                    strokeLinejoin="round"
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-2">
                                            ...
                                            <Label htmlFor="mobile-payments">
                                                {t("settings.mobile_payments")}
                                            </Label>
                                        </div>
                            ...
                            <div className="space-y-4">
                                <h3 className="text-lg font-medium">
                                    {t("settings.receipt_options")}
                                </h3>
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-2">
                                            <Printer className="h-4 w-4" />
                                            <Label htmlFor="print-receipt">
                ...
                <TabsContent value="receipt">
                    <Card>
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="space-y-4">
                                <h3 className="text-lg font-medium">
                                    {t("settings.receipt_content")}
                                </h3>
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-2">
                                            <Label htmlFor="show-tax">
                                                {t("settings.show_tax")}
                                            </Label>
                                        </div>
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-2">
                                            <Label htmlFor="allow-discounts">
                                                {t("settings.allow_discounts")}
                                            </Label>
                                        </div>
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-2">
                                            <Label htmlFor="allow-refunds">
                                                {t("settings.allow_refunds")}
                                            </Label>
                                        </div>
                                        <Switch
                                            id="allow-refunds"
