...
const orders = [
  {
    ...
    status: "pending",
    items: [
      { id: 1, name: "Margherita Pizza", quantity: 2, notes: "Extra cheese", status: "pending" },
  ...
  },
  {
    ...
    status: "in-progress",
    items: [
      { id: 3, name: "Grilled Chicken", quantity: 1, notes: "Well done", status: "in-progress" },
      { id: 4, name: "French Fries", quantity: 2, notes: "Extra crispy", status: "completed" }
    ],
